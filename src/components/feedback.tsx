...
async function createBenevolat({ name, country, email, message }: { name: string, country: string, email: string, message: string }) {
    const endpoint = HYGRAPH_ENDPOINT_URL;

    const createContactMutation = `
        mutation CreateContact($name: String!, $email: String!, $country: String!, $message: String!) {
            createContact(data: {name: $name, email: $email, country: $country, message: $message}) {
                name
                email
                country
                message
    ...
    const variables = {
        name, // Remplacez par la valeur réelle
        email,   // Remplacez par la valeur réelle
        country, // Remplacez par la valeur réelle
        message  // Remplacez par la valeur réelle
    };
